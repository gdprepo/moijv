...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.avatar' => 'getSmartUniqueNamer_AvatarService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Subscriber\\SlugListener' => ['privates', 'App\\Subscriber\\SlugListener', 'getSlugListenerService', true],
            'doctrine.orm.default_listeners.attach_entity_listeners' => ['privates', 'doctrine.orm.default_listeners.attach_entity_listeners', 'getDoctrine_Orm_DefaultListeners_AttachEntityListenersService', true],
        ], [
            'App\\Subscriber\\SlugListener' => '?',
        ...
        $c->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('avatar', $d, $e, $f));
        $c->addEventSubscriber(new \Symfony\Bridge\Doctrine\SchemaListener\PdoCacheAdapterDoctrineSchemaSubscriber([]));
        $c->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('avatar', $d, $e, $f));
        $c->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('avatar', $d, $e, $f));
        $c->addEventListener([0 => 'prePresist'], 'App\\Subscriber\\SlugListener');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('category_repo', ($this->privates['App\\Repository\\CategoryRepository'] ?? $this->getCategoryRepositoryService()));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'vich_uploader.mappings' => [
                'avatar' => [
                    'uri_prefix' => '/avatar',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/avatar'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.avatar',
                        'options' => [
